    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href={{'/sidebar/AngularLab1'}} class="list-group-item">Angular 1.5: Lab 1</a>
        ...
        <div class="col-md-9">
         ...
         <table class="tg" style="undefined; ">
           ...
           <tr>
             <td class="tg-yw4l">Angular 1.5: Lab 1 </td>
             <td class="tg-9hbo">$scope, $rootscope, controller, models, expression & debugging.  <a href={{'/sidebar/AngularLab1'}} class="btn btn-default">Preview</a></td>
             <td class="tg-lqy6">25m</td>
           </tr>
          <tr>
              <td class="tg-yw4l">Angular 1.5: Lab 2</td>
              <td class="tg-9hbo">Digest Cycle, watchers, One time, $watch and $apply. <a href="#" class="btn btn-default">Preview</a></td>
              <td class="tg-lqy6">25m</td>
            </tr>
            <tr>
              <td class="tg-yw4l">Angular 1.5: Lab 3</td>
              <td class="tg-9hbo">Services and Factory<a href="#" class="btn btn-default">Preview</a></td>
              <td class="tg-lqy6">25m</td>
            </tr>
            <tr>
              <td class="tg-yw4l">Angular 1.5: Lab 4</td>
              <td class="tg-9hbo">WooCommerce payments premium </td>
              <td class="tg-lqy6">25m</td>
            </tr>  <!-- /.row -->
